                                                            ...
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center"
                                                                    style="line-height:10px;padding-top: 40px;"><img
                                                                        src="{{url('')}}/website/assets/img/logo.png"
                                                ...
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="20" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h1
                                                                    style="margin: 0; color: #28b4e8; font-size: 19px; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: 1px; margin-top: 0; margin-bottom: 0;">
                                                                    <span
                                                                        class="tinyMce-placeholder">{{ trans('website.title_for_mail') }}</span>
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div
                                                                    style="color:#000000;font-size:14px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:400;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;">
                                                                    ...
                                                                    <div style="padding:10px 0">
                                                                        <a href="{{url('')}}{{$item['slug']}}" style="
		display: block;
		color:#000; 
		outline: none;
		list-style: none;
		text-decoration-line: none;
	" target="blank"><b>{{$item['title']}} </b> </a>
                                                                        <small style="display: block; "> <b>Date :</b>
                                                                            {{$item['date']}}</small>
                                                                        <hr>
                                                                    </div> 
                                                                    @endforeach
                                                                    ...
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://marinefishcluster.ge/en" style="height:42px;width:131px;v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#3AAEE0"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]--><a
                                                                        ...
                                                                        target="_blank"><span
                                                                            style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                                style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;">Unsubscribe</span></span></a>
...
@component('mail::button', ['url' => 'https://stateless.azurewebsites.net/en'])
site
@endcomponent
